...
return {
  ...
  apply(ctx) {
    ...
    harness.registerTool(ctx, harness.defineTool({
      ...
      parameters: { sessionId: { type: 'string', required: true, description: 'Agent-specified session id. MUST be a kebab-case task slug naming this session\'s goal — at least 3 chars with at least one letter, e.g. \'memory-system-skill-dev\'. Never a bare number, UUID, timestamp, or generic word like \'session\'/\'test\'.' } },
